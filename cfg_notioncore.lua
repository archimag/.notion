...
defbindings("WMPlex.toplevel", {
    ...
    kpress(META.."F5", "notioncore.exec_on(_, 'gnome-control-center')"),
    ...
    kpress("XF86Launch5", "ioncore.exec_on(_, 'nautilus --no-desktop')"),
    kpress("XF86Launch6", "ioncore.exec_on(_, 'emacs')"),
    kpress("XF86Launch7", "ioncore.exec_on(_, 'google-chrome-stable')"),
    kpress("XF86Launch8", "ioncore.exec_on(_, 'firefox-bin')"),
    kpress("XF86Launch9", "ioncore.exec_on(_, 'transmission-gtk')"),
    -- kpress("XF86Calculator", "mod_query.query_exec(_)"),
    kpress("XF86Calculator", "ioncore.exec_on(_, '/home/andrey/bin/turn-mouse-map')"),
    kpress("XF86Mail", "ioncore.exec_on(_, 'libreoffice -o \"/home/andrey/Documents/Tander/СППР.ods\"')"),

    kpress("XF86HomePage", "ioncore.exec_on(_, 'wesnoth')"),
    kpress("XF86Search", "ioncore.exec_on(_, '/home/andrey/Game/DarkPlacesRM/nexuiz-dprm-sdl')"),
})
